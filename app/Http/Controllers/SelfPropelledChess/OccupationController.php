...
class OccupationController extends Controller
{
    ...
    {
        $occupation = Occupation::where('type',1)->get();// 获取所有角色

        return view('chess.occupation.index')->with('occupation', $occupation);
    }

    public function create()
    {
        return view('chess.occupation.create');
    }
    ...
    public function show($id)
    {
        ...
        $pieces = Pieces::select('pieces.*')
            ...
            ->get();
        return view('chess.occupation.show',compact('occupation','fetters','pieces'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('chess.occupation.edit', compact('occupation', 'fetters'));
    }
