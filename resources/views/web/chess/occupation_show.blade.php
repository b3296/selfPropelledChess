...
@section('content')
    ...
    <div class="col-lg-10 col-lg-offset-1">
        ...
        <h3><i class="fa fa-key"></i> 职业技能：{{$occupation->fetters_description}} </h3>
        <hr>
        <h4><b>触发个数与效果:</b></h4>
            ...
            <table class="table table-bordered table-striped">
                ...
                @foreach ($pieces as $piece)
                    ...
                    <tr>
                        ...
                        <td><a href="{{ route('web.chess.piece.show', $piece->id) }}">{{ $piece->name }}</a></td>
                        <td>{{ $piece->expend }}</td>
                        <td>{{ $piece->skill_description }}</td>
                        <td>
                            <a href="{{ route('web.chess.piece.show', $piece->id) }}">
