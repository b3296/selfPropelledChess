        ...
        <div style="margin:0 auto; text-align:center">
            ...
            <h4><img src="{{env('APP_URL').'/'.$piece->url}}" style="margin-right: 3px;">
                    ...
                    @foreach ($piece->occupation as $occupation)
                        <a href="{{ route('web.chess.occupation.show', $occupation->id) }}" class="btn btn-info " style="margin-right: 3px;">
                            {{$occupation->name}}
                        </a>
                    ...
                    @foreach ($piece->race as $race)
                        <a href="{{ route('web.chess.occupation.show', $race->id) }}" class="btn btn-info " style="margin-right: 3px;">
                            {{$race->name}}
                        </a>
